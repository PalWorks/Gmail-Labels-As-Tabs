...
const DEMO_ITEMS: CarouselItem[] = [
  {
    type: 'image',
    src: '/Gmail-Labels-As-Tabs/banner-05.png',
    alt: 'Gmail Labels as Tabs extension with dark mode support'
  },
  {
    type: 'image',
    src: '/Gmail-Labels-As-Tabs/banner-03.png',
    alt: 'Pin Gmail search queries as tabs for one-click access'
  },
  {
    type: 'image',
    src: '/Gmail-Labels-As-Tabs/banner-01.png',
    alt: 'Drag and drop to reorder Gmail label tabs'
  },
  {
    type: 'image',
    src: '/Gmail-Labels-As-Tabs/banner-02.png',
    alt: 'Rename and customize pinned Gmail tabs'
  },
  {
    type: 'image',
    src: '/Gmail-Labels-As-Tabs/banner-04.png',
    alt: 'Edit tab details in Gmail Labels as Tabs settings'
  }
];
...
export const Home: React.FC = () => {
  ...
  useEffect(() => {
    document.title = 'Gmail Labels as Tabs | Free Chrome Extension to Organize Your Inbox';
  }, []);
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {FAQ_ITEMS.map((item, idx) => (
              <details key={idx} className="group bg-[#F6F8FC] rounded-2xl border border-[#E1E3E1] overflow-hidden">
                <summary className="flex items-center justify-between cursor-pointer p-6 text-[#1F1F1F] font-medium text-lg select-none">
                  {item.question}
                  <Plus className="w-5 h-5 text-[#444746] transition-transform duration-200 group-open:rotate-45 flex-shrink-0 ml-4" />
                </summary>
                <div className="px-6 pb-6 text-[#444746] leading-relaxed">
                  {item.answer}
                </div>
              </details>
            ))}
